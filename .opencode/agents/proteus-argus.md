...
- **Devil's Advocate (Refutation Step)**: Before finalizing a hypothesis, explicitly state why your hypothesis is likely a false positive. List assumptions and why this attack would fail in a real scenario. Skeptic will use this.
