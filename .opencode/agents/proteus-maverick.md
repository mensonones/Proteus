...
2. **Identify Invariants:** List the absolute truths of the component (e.g.,
   "Users can only see their own data", "Balance cannot be negative", "Steps A,
   B, and C must happen in order").
