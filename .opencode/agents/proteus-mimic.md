...
Network: route any outbound requests (e.g. pulling Docker images, fetching
runtime metadata, or downloading adapters) through Tor by prefixing each command
...
Before returning, remove any Docker images, containers, or runtime
environments pulled or built solely for this front. Delete temporary
configuration files and adapter scaffolding.
