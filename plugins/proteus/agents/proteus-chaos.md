...
Before returning, delete all temporary harness scripts, test inputs, and
crash/noise output files created during this front unless they are needed
by the next explicit step.
