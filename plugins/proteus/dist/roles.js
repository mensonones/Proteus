...
exports.ROLES = {
    ...
    libris: {
        ...
        purpose: "Verify official docs, tests, advisories, issues, releases, changelogs, public-known behavior, and timeline to establish the contract a candidate may break.",
    ...
    skeptic: {
        ...
        purpose: "Try to refute or downgrade a candidate through expected-behavior, duplicate, public-known, timeline, misuse, missing-control, impact, and negative-control arguments.",
    ...
    cicada: {
        ...
        purpose: "Strengthen promising signals into realistic exploit strategies by reducing blockers, designing bypass paths, and clarifying chain requirements without promoting unvalidated claims.",
        startsWhen: "A branch already has concrete signal but still needs bypass design, chaining, exploit reliability, impact proof, or a lab-grade PoC path.",
        requiredOutput: [
