...
export const ROLES: Record<AgentCodename, RoleDefinition> = {
  ...
  maverick: {
    ...
    purpose:
      "Hunt 0-days through First Principles by mapping system invariants and breaking business logic via absurd interactions, state machine drift, side-effect chaining, and feature weaponization, ignoring classic OWASP-style bug classes.",
  ...
  janus: {
    ...
    purpose:
      "Systematically map the authorization matrix (actors, operations, objects) and hunt Broken Access Control: IDOR/BOLA, vertical and horizontal privilege escalation, tenant isolation gaps, and missing or inconsistent enforcement checks.",
